...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2343.70; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3138.34; // x position of the perpendicular encoder (in tick units)
    }
